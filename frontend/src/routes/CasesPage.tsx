        ...
        {selectedCase && (
          <>
            ...
            <div style={{ 
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr auto', border: '1px solid #2a2e35', borderRadius: 6, overflow: 'hidden', marginTop: 8 }}>
                <div style={{ padding: '10px 0', textAlign: 'center', fontSize: 13, fontWeight: 500, color: '#fff', borderRight: '1px solid #2a2e35' }}>Analyze Body</div>
                <div style={{ padding: '10px 0', textAlign: 'center', fontSize: 13, fontWeight: 500, color: '#9ca3af', borderRight: '1px solid #2a2e35' }}>Scan Attachments</div>
                <div style={{ padding: '10px 0', textAlign: 'center', fontSize: 13, fontWeight: 500, color: '#9ca3af', borderRight: '1px solid #2a2e35' }}>Analyze Headers</div>
                <div style={{ padding: '10px 16px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <i className="fa-solid fa-layer-group" style={{ color: '#9ca3af' }} />
                </div>
              </div>
            ...
            {/* Timeline Area */}
            <div style={{ flex: 1, display: 'flex', background: '#13151a' }}>
              <div style={{ width: 48, borderRight: '1px solid #1c1e23', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 24, paddingTop: 24 }}>
                <i className="fa-solid fa-code-branch" style={{ color: '#e2e8f0' }} />
                <i className="fa-regular fa-pen-to-square" style={{ color: '#9ca3af' }} />
                <i className="fa-solid fa-user-shield" style={{ color: '#9ca3af' }} />
              </div>
                  ...
                  {[
                    ...
                    <div key={i} style={{ display: 'flex', gap: 16, position: 'relative', zIndex: 2 }}>
                      ...
                      <div style={{ paddingTop: 6 }}>
                        ...
                        <div style={{ fontSize: 12, color: '#9ca3af' }} dangerouslySetInnerHTML={{ __html: evt.sub.replace('Workflow', '<span style="text-decoration:underline;cursor:pointer;">Workflow</span>') }} />
                      </div>
                    </div>
                  ))}
                </div>
            ...
            {/* Bottom Input */}
            <div style={{ padding: '16px 24px', borderTop: '1px solid #1c1e23', background: '#0e1015', display: 'flex', gap: 12, alignItems: 'center' }}>
            ...
            <div className="animate-fade-in" style={{ flex: 1, background: '#1c1e23', display: 'flex', flexDirection: 'column', overflowY: 'auto' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 24px', borderBottom: '1px solid #2a2e35' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
                  <button style={{ background: 'none', border: 'none', color: '#9ca3af', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8 }}><i className="fa-solid fa-arrow-left" /></button>
                  <button style={{ background: 'none', border: 'none', color: '#9ca3af', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8 }}><i className="fa-solid fa-arrow-right" /></button>
                ...
                <div style={{ padding: '32px 48px', maxWidth: 1000, margin: '0 auto', width: '100%', display: 'flex', flexDirection: 'column', gap: 32 }}>
                  ...
                  <div>
                    ...
                    <div style={{ color: '#e2e8f0', fontSize: 13, lineHeight: 1.6, display: 'flex', flexDirection: 'column', gap: 12 }}>
                      ...
                      <div><span style={{background: '#8b5cf6', color: '#fff', padding: '2px 6px', borderRadius: 4, fontWeight: 600, fontSize: 12, marginRight: 8}}>Impact:</span> The phishing attack aimed to compromise the recipient's computer or network through malicious downloads...</div>
