...
export function Sidebar() {
  ...
  return (
    <aside 
      ...
      <div ref={menuRef} style={{ position: 'relative', whiteSpace: 'nowrap', overflow: 'visible', zIndex: 30 }}>
        <div 
        ...
        {workspaceMenuOpen && !isCollapsed && (
          <div className="animate-fade-in" style={{ 
            ...
            borderRadius: 8, padding: 8, zIndex: 300, display: 'flex', flexDirection: 'column', gap: 2, 
